...
int main(void)
{
    ...
    while (1)
    {
        ...
        printf("ax: %f\t", ((float)ax - accel_x_offset) / 16384.0);
        printf("ay: %f\t", ((float)ay - accel_y_offset) / 16384.0);
        printf("az: %f\t", ((float)az - accel_z_offset) / 16384.0);
        printf("gx: %f\t", ((float)gx - gyro_x_offset) / 131.0);
        printf("gy: %f\t", ((float)gy - gyro_y_offset) / 131.0);
